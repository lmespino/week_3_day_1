...
#print(name + " liked to hum the song " + song + " while coding. " + "It was so annoying that their teammates would throw " + str(food) + " until " + str(name) + " would stop singing.")

# Still, [name] was the best coder on the team and could write [number] lines of code every day. Maybe [song] was [name]’s secret power?
#rint("Still, " + name + " was the best coder on the team and could write " + str(number) + " lines of code every day. Maybe " + song + " was " + name + "'s secret power?")
...
# #floor method
print(floor(3.7)) # floor method rpunds down
# #ceil method
#print(ceil())
# #sqrt method
#print(sqrt())
